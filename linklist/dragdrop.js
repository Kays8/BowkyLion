...
Work : แสดงรายการแสดงข้อความการต่อโบกี้ 
EX. 1 -->  3 --> 5
...
let carriageCount = 0;
let carriageType = 'train'; // เพิ่มตัวแปรใหม่
let dragged;
document.addEventListener('DOMContentLoaded', (event) => {
  ...
  window.addCarriage = function() {
    ...
    newCarriage.innerHTML = `<img src="${carriageType}.png" alt="BOWKY LIONS ${carriageCount}">`;
